/* Filename PassArrayElelments .java
 * Written by Java Progamming
 * Description : Demonstrates the passing of arrays using methods                */
package passarrayelements;
public class PassArrayElements 
{
